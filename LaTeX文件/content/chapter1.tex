...
上面提到的VMware Workstation Pro和VMware Fusion还有Ubuntu24.04 LTS镜像文件，我打包了一个压缩包，放在了\textbf{\textcolor{blue}{\href{https://pan.quark.cn/s/bfc066dbd66a}{夸克网盘}}}可以直接下载解压后使用。
也可以加入学习通课程（邀请码\code{91364739}），在课程资料中获取（下载可能会快一些），由于学习通限制，所有文件打包成了压缩包，请解压使用。
邀请码2026年8月7日前有效，我会不断更新并发布在Github上。
