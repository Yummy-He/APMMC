...
水平所限，难免疏漏，如有错误，恳请指正。如果有错误反馈、有修改建议、或有更好的代码示例，都欢迎在GitHub上提交Issue或Pull Request，或电子邮件联系我（GitHub地址和联系方式在封面页）。

本笔记也会不断更新，会发布在GitHub项目库的\href{https://github.com/Yummy-He/APMMC/releases}{\textbf{\textcolor{blue}{release}}}（蓝色粗体可直接点击进入链接，下同）中，欢迎关注。
