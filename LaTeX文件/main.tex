...
\definecolor{qhui}{RGB}{240, 240, 240} % 浅灰
...
% 临时修改 hyperref 设置：启用边框（宽度非零）并设为下划线样式
\let\oldurl\url
\renewcommand{\url}[1]{%
  \begingroup
  \hypersetup{
    pdfborder={0 0 1},          % 边框宽度为 1pt（可根据需要调整）
    pdfborderstyle={/S/U},      % 下划线样式
    urlbordercolor=black        % 下划线颜色设为黑色（可自定义）
  }%
  \oldurl{#1}%
  \endgroup
}
...
\newcommand{\contact}{
    ...
    \textcolor{black}{
        % 邮箱
        \faGithub \ \href{https://yummy-he.github.io/project/APMMC/}{项目主页： https://yummy-he.github.io/project/APMMC/}
        \\
        % \raisebox{-0.14em}{\includegraphics[height=1em]{gitee-logo.png}} \href{https://gitee.com/Yummy-He/APMMC}{\texttt{Gitee}项目地址：https://gitee.com/Yummy-He/APMMC}
        % \\
        \faEnvelope \quad \href{mailto:hongym1223@mails.jlu.edu.cn}{hongym1223@mails.jlu.edu.cn} ,\quad \href{mailto:yummy_he_mail@qq.com}{yummy\_he\_mail@qq.com}
        % \hspace{4em}
    }
}
